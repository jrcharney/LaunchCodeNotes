...
> 🪓 **Urge to expand this section...rising.** There is so much you should know about [Boolean Algebra](https://en.wikipedia.org/wiki/Boolean_algebra) that I want to include in these notes. Maybe I'll get back to it later. Chapter 4 had a LOT of stuff crammed in it that I added.
...
During this studio, we will ask you to think about your mindset when it comes to facing challenges: Do challenges deter you ro delight you? If challenges are something you delight in, you might have a growth mindset.
...
After your TA reviews the relevant topics, we will have a discusssion covering the following:
